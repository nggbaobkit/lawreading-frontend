...
import { withSoundCloudAudio } from 'react-soundplayer';
import { PlayButton, Progress, VolumeControl } from 'react-soundplayer';

const nasaBg = '../../images/player-bg.jpg';
    ...
    return (
      <div className="py2 white bg-cover bg-top rounded relative" style={{backgroundImage: `url(${nasaBg})`}}>
        ...
        <div className="center py4 relative z1">
          <h3 className="h4 nowrap caps mb0">JOHNNY JEWEL</h3>
          <h2 className="h0 nowrap caps m0">GLASS CANDY - SHELL GAME</h2>
        </div>
